...
/**
 * Created by Anurag10 on 5/18/2017.
 */
...
public class BillingHistory extends Fragment{
    ...
    private List<BillingInfo> listBillingInfos;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.billing_history, container, false);
    }
    @Override
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle(Config.Billing_History_Category);
        ...
        listBillingInfos = new ArrayList<>();
        ...
        adapter = new CardAdapter(listBillingInfos, getContext());
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
        ...
        builder.scheme("https")
                ...
                .appendPath("android")
                .appendPath("billingHistory.php")
                .appendQueryParameter("page",String.valueOf(requestCount))
                .appendQueryParameter("customerId",customerId);
        String billingHistoryUrl = builder.build().toString();
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(billingHistoryUrl, new Response.Listener<JSONArray>() {
            @Override
    ...
    private void parseData(JSONArray array) {
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                billingInfo.setBillNumber(json.getString(Config.TAG_BILL_NUMBER));
                billingInfo.setTotalDriveTime(json.getString(Config.TAG_TOTAL_DRIVE_TIME));
                billingInfo.setTotalAmount(json.getString(Config.TAG_AMOUNT));
                billingInfo.setPaymentStatus(json.getString(Config.TAG_PAYMENT_STATUS));
                maxLimit = Integer.parseInt(json.getString(Config.TAG_MAX_LIMIT));
            } catch (JSONException e) {
                e.printStackTrace();
            }
            //Adding the superhero object to the list
            listBillingInfos.add(billingInfo);
        }
